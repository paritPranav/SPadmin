...
export default function MakePost() {
  ...
  const makePost=()=>{
     if(localStorage.getItem('authtoken')!=null){
      const BaseURL="http://localhost:3000/posts/createPost";
      axios.post(BaseURL,{
  ...
  return (
    <div style={{margin:"1% 2% 1% 2%"}}>
      ...
      <form className='form'>
        ...
        <input list="cars" className='form form-control' id="category" onChange={(e)=>{setcategory(e.target.value)}}/>
        <datalist id="cars" >
        ...
        <input type="file"  id='upload' onChange={(e)=>{uploadImage(e)}}  className='form form-control'/>
